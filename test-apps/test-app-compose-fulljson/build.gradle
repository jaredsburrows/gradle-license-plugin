...
licenseReport {
  // Only the full JSON report, copied to src/main/assets/open_source_licenses.full.json. It holds
  // everything the JSON report has plus the full text of every known license.
